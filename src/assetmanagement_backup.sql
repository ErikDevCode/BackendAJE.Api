...
--
-- Current Database: `assetmanagement`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `assetmanagement` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `appusers` (`appUserId`, `userId`, `routeOrEmail`, `passwordHash`, `createdAt`, `updatedAt`, `createdBy`, `updatedBy`) VALUES (1,1,'erik.abanto@gmail.com','$2a$11$3IU9VQFjQWSsVq43LU1RXOO5128iE7SBwVUlLyAUGvKYwyvYRH1m.','2024-09-09 15:54:13','2024-09-10 04:12:44',1,1),(2,2,'cesargpq@gmail.com','$2a$11$cXGJkZLe84rH6YnfKr8bFOGbrwjNVwdOm8LaKe2DRD2MzgdQRo87e','2024-09-09 22:40:43','2024-09-15 19:23:35',NULL,NULL),(3,3,'10001','$2a$11$EExk37co4nWRKgvKutxzc.qU15qCXdjB.zhuIDbbvnLgMtjzzKDfq','2024-09-10 03:48:15','2024-09-10 03:48:15',NULL,NULL),(7,7,'10002','$2a$11$UDDXJLOXcK9xkOW3xmkdSOR.ieLGrscgZQAjftiFJTMqSyixr99sK','2024-09-15 20:21:36','2024-09-15 20:21:36',2,2),(8,8,'10003','$2a$11$PCPC2DO5u7TYZx0keHsc5uQ0.FEcZ4cW3DqXqMdRGwltcAh7IpqLu','2024-09-15 15:53:48','2024-09-15 15:53:48',2,2),(9,9,'10004','$2a$11$jY6gSKwENY8cTuZegY9rlegqn9T6OHw7RVNSqGOJM9cI.rHPPqSR.','2024-09-16 02:54:54','2024-09-16 02:54:54',1,1);
...
INSERT INTO `userroles` (`userRoleId`, `userId`, `roleId`, `createdAt`, `updatedAt`, `createdBy`, `updatedBy`) VALUES (1,1,1,'2024-09-09 16:01:32','2024-09-09 16:01:32',1,1),(2,2,1,'2024-09-09 17:48:13','2024-09-14 23:02:24',1,1),(4,3,6,'2024-09-09 22:48:15','2024-09-14 23:02:24',1,1),(5,7,6,'2024-09-15 20:21:36','2024-09-15 20:21:36',2,2),(6,8,6,'2024-09-15 15:53:48','2024-09-15 15:53:48',2,2),(7,9,6,'2024-09-16 02:54:54','2024-09-16 02:54:54',1,1);
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_zone__fk` FOREIGN KEY (`zoneId`) REFERENCES `zones` (`zoneId`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-15 22:16:58
